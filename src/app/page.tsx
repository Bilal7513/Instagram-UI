...
const Signup: React.FC = () => {
  return (
    <div className="mt-[12px] mb-[55px] bg-black flex gap-8 items-center justify-center text-white text-sm">
      <div className="w-[41%] mr-[50px] mt-[22px]">
      ...
      <div className="w-[350px] flex flex-col items-center ml-[-38px] mt-[32px] px-[40px] py-[10px]">
        ...
        <form className="w-full flex flex-col gap-[6px] mt-[12px]">
          ...
          <button className="bg-[#4a5df9] text-white rounded-lg text-sm font-semibold py-1.5 mt-2">Log in</button>
        </form>
        ...
        <Link href="#" className="text-[#e0f1ff] text-[14px] font-medium mt-[7px] mb-[11px]">Forgot password?</Link>
      <div className="w-full max-w-[350px] text-center mt-[20px] py-[20.5px]">
